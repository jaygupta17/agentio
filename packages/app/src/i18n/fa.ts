export const dict = {
  ...
  "settings.e2b.title": "Cloud sandboxes",
  "settings.e2b.key": "E2B API key",
  "settings.e2b.keyRequired": "E2B API key is required",
  "settings.e2b.passwordRequired": "Set a serve password first (generate one)",
  "settings.e2b.generate": "Generate",
  "settings.e2b.keys": "Model keys (one per line, provider=key)",
  "settings.e2b.keysPlaceholder": "anthropic=sk-…",
  "settings.e2b.remember": "Remember secrets on this device (encrypted)",
  "settings.e2b.list": "List my sandboxes",
  "settings.e2b.use": "Use selected (connects + resumes)",
  "settings.e2b.forget": "Forget device",
  "settings.e2b.pause": "Pause (keep files)",
  "settings.e2b.template": "Template",
  "settings.e2b.timeout": "Timeout (minutes)",
  "settings.e2b.create": "Create + boot + connect",
  "settings.e2b.progress.creating": "Creating sandbox…",
  "settings.e2b.progress.starting": "Starting serve…",
  "settings.e2b.progress.waiting": "Waiting for healthy…",
  "settings.e2b.versionMismatch": "Serve version differs from app pin",
  "settings.e2b.openOfficial": "Open official web UI ↗",  "onboarding.title": "Set up agentio",
  "onboarding.subtitle": "Talk to your agents wherever they run — start a cloud sandbox or connect a server you already have.",
  "onboarding.choice.cloud": "Start an E2B cloud sandbox",
  "onboarding.choice.cloudDescription": "Bring your own E2B API key. The agent runs in your cloud, billed to your account.",
  "onboarding.choice.remote": "Connect an existing server",
  "onboarding.choice.remoteDescription": "Any reachable opencode serve URL (it must allow this origin for CORS).",
  "onboarding.step.keys": "Connect your cloud",
  "onboarding.step.modelKeys": "Add model keys",
  "onboarding.step.launch": "Launch your sandbox",
  "onboarding.step.done": "Done",
  "onboarding.cloud.billingNote": "Sandboxes bill to your E2B account. Keys stay encrypted on this device.",
  "onboarding.cloud.launchNote": "Booting the sandbox template takes about a minute.",
  "onboarding.cloud.done": "Sandbox {sandbox} is healthy. Your first session is one tap away.",
  "onboarding.change": "Choose a different setup",
  "onboarding.continue": "Continue",
  "onboarding.back": "Back",
  "onboarding.launch": "Launch sandbox",
  "onboarding.launching": "Launching…",
  "onboarding.waiting": "Ready — loading your workspace…",
  "onboarding.remote.url": "Server URL",
  "onboarding.remote.username": "Username",
  "onboarding.remote.connect": "Connect",
  "onboarding.remote.hint": "Works with any opencode serve that allows this origin (CORS). Credentials are encrypted on this device.",
  "onboarding.connecting": "Connecting…",
  "settings.e2b.wake": "Wake + start serve",
  "settings.e2b.restartServe": "Restart serve",
  "e2b.error.auth": "Authentication failed — check the server password.",
  "e2b.error.notFound": "Not found — it may have been deleted or the workspace path is wrong.",
  "e2b.error.busy": "Busy — stop the running task first.",
  "e2b.error.unreachable": "Cannot reach the server — check the URL, credentials, network, and that this origin is CORS-allowed.",
  "e2b.error.server": "Server error — try again in a moment.",
  "e2b.error.raw": "{message}",
  "config.title": "Server configuration",
  "config.back": "Back to sessions",
  "config.scope": "Scope",
  ...
  "config.applyReload": "Restart server to apply ({count})",
  "config.deleteRequiresSandbox": "Deleting config entries requires an E2B-connected server.",
  "config.projectNeedsSandbox": "Project-level config lives in .opencode/ files — connect through E2B to edit a project, or switch to Global.",
  "config.permissions": "Permissions",
  "config.permissionsHint": "Default tool behavior for agents on this server. Agents can tighten it; sessions can escalate per request.",
  "config.permissionsRemoteHint": "Edits save globally over HTTP. Removing entries needs an E2B sandbox — use Inherit plus disable-shapes here.",
  "config.permission.default": "Agent default",
  "config.permission.defaultHint": "Applies to every tool unless overridden below.",
  "config.permission.effective": "Effective: {action}",
  "config.permission.patternPlaceholder": "pattern, e.g. git commit*",
  "config.permission.addRule": "Add rule",
  "config.permission.addKey": "Add key",
  "config.permission.customKey": "custom tool key",
  "config.permission.clearRemote": "Cleared locally — remote servers cannot remove the whole section via merge-patch. Connect a sandbox to wipe it, or set keys to Inherit.",
  "config.agents.title": "Agents & subagents",
  "config.agents.new": "New agent",
  "config.agents.name": "Name",
  "config.agents.nameHint": "lowercase letters, digits, dashes — used by delegation",
  "config.agents.invalidName": "Invalid agent name",
  "config.agents.nameTaken": "An agent with this name already exists",
  "config.agents.description": "Description",
  "config.agents.mode": "Mode",
  "config.agents.mode.primary": "Primary",
  "config.agents.mode.subagent": "Subagent",
  "config.agents.mode.all": "Both",
  "config.agents.model": "Model",
  "config.agents.modelHint": "provider/model — leave empty to inherit",
  "config.agents.variant": "Variant",
  "config.agents.temperature": "Temperature",
  "config.agents.topP": "Top P",
  "config.agents.prompt": "System prompt",
  "config.agents.builtIn": "built-in",
  "config.agents.overrideBuiltIn": "This overrides the built-in agent's config; its core behavior stays server-side.",
  "config.agents.remoteDelete": "Deleting or clearing agents needs sandbox file access. Edits and adds work over HTTP everywhere.",
  "config.agents.mirrorFile": "Also write this agent as agents/<name>.md in the config dir",
  "config.pickAgent": "Pick an agent or create one",
  "config.commands.title": "Commands",
  "config.commands.new": "New command",
  "config.commands.name": "Name",
  "config.commands.nameHint": "slash-command name",
  "config.commands.pick": "Pick a command or create one",
  "config.commands.description": "Description",
  "config.commands.agent": "Agent",
  "config.commands.subtask": "Run as subtask",
  "config.commands.template": "Template",
  "config.commands.templateHint": "$ARGUMENTS, !`shell` and @file references are expanded by the server",
  "config.commands.invalidName": "Invalid command name",
  "config.commands.remoteHint": "Deleting commands needs sandbox file access; edits and adds work everywhere.",
  "config.mcp.new": "Add MCP server",
  "config.mcp.name": "Name",
  "config.mcp.nameRequired": "Name is required",
  "config.mcp.local": "Local (command)",
  "config.mcp.remote": "Remote (URL)",
  "config.mcp.command": "Command",
  "config.mcp.commandHint": "one argument per line, e.g. npx / -y / some-mcp",
  "config.mcp.url": "URL",
  "config.mcp.environment": "Environment",
  "config.mcp.headers": "Headers",
  "config.mcp.addRow": "Add row",
  "config.mcp.enabled": "Enabled",
  "config.mcp.connect": "Connect",
  "config.mcp.disconnect": "Disconnect",
  "config.mcp.untried": "not started",
  "config.mcp.pick": "Pick a server or add one",
  "config.mcp.oauthDeferred": "This server wants OAuth — the consent round-trip is on the roadmap. Configure static headers or a key-based endpoint for now.",
  "config.skills.title": "Skills",
  "config.skills.new": "New skill",
  "config.skills.name": "Skill name",
  "config.skills.nameHint": "lowercase identifier — becomes the SKILL.md name",
  "config.skills.pick": "Pick a skill",
  "config.skills.instructions": "Instructions",
  "config.skills.discovery": "Skill discovery",
  "config.skills.discoveryHint": "Extra directories and index.json URLs the server scans, beyond its built-in locations.",
  "config.skills.paths": "Paths",
  "config.skills.pathsHint": "absolute or ~ per line, e.g. ~/custom/skills",
  "config.skills.urls": "URLs",
  "config.skills.invalidName": "Invalid skill name",
  "config.skills.remoteHint": "SKILL.md authoring needs an E2B sandbox. Browsing and discovery config work here.",
  "config.skills.readOnlyLocation": "This skill lives outside the config jail (e.g. ~/.claude/skills) — shown read-only.",
  "config.plugins": "Plugins",
  "config.pluginsHint": "npm specs or [spec, options]. The whole plugin array is replaced on save — works on every server.",
  "config.plugins.add": "Add plugin",
  "config.plugins.empty": "No plugins configured.",
  "config.plugins.options": "Options (JSON)",
  "config.plugins.invalidJson": "Options must be valid JSON.",
  "command.config.server": "Configure server",
  "config.providerKeys": "Provider keys ↗",
}
